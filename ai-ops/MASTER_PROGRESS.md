...
| explain-risk-and-verification | explanation-practice | explain-risk-verification | ✓ | ✓ | — | — | P-05 Project Completion Wave A, diagram·glossary·KB consumers 반영, lint/typecheck PASS |
| mini-saas-architecture | project-textbook | mini-saas-architecture | ✓ | ✓ | — | — | P-05 Project Completion Wave A, diagram·glossary·KB consumers 반영, lint/typecheck PASS |
| admin-dashboard-project | project-textbook | admin-dashboard-project | ✓ | ✓ | — | — | P-05 Project Completion Wave A, diagram·glossary·KB consumers 반영, lint/typecheck PASS |
| ai-chatbot-project | project-textbook | ai-chatbot-project | ✓ | ✓ | — | — | P-05 Project Completion Wave A, diagram·glossary·KB consumers 반영, lint/typecheck PASS |
| automation-workflow-project | project-textbook | automation-workflow-project | ✓ | ✓ | — | — | P-05 Project Completion Wave A, diagram·glossary·KB consumers 반영, lint/typecheck PASS |
...
| Verify 통과 | 90 / 100 | 90% (`npm run verify` PASS 기준 90강, integrated 5강 P-06 대기) |
