...
| 연속 실행 규칙 | P-01 완료 후 같은 흐름에서 P-02 진행 가능. 단 P-02는 원문 URL 재접속 대조와 보고서 기록 필수 | 다음 | P-02 |
...
## 다음 단계
- 완료 보고에 생성한 파일 경로 목록을 나열 → 같은 Codex 흐름에서 P-02를 이어서 수행할 수 있다.
- P-02에서는 수집 때의 기억을 근거로 삼지 말고, 모든 URL을 다시 열어 원문 대조 기록을 남긴다.
