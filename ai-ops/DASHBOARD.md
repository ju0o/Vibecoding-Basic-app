...
| Build / Verify | `░░░░░░░░░░` 0% (0/12) | **파일럿 verify 대기 중** |
| Release | `░░░░░░░░░░` 0% (0/12) | |
...
| Cline | (없음) | 대기 — **다음: P-06 (파일럿 verify)** |
| Fable | O-01 완료 (2026-07-04) | M10 = 15강 확정, 1차 KB 배치 확정. 다음: O-02는 강의 10개 릴리스 후 |

## 현재 병목 (Bottleneck)

1. **파일럿 verify 미실행** — src/content 변경 3파일이 미검증·미커밋. 이것이 풀려야 릴리스 라인이 검증됨
2. KB 0건 — P-01이 시작되지 않으면 P-02 이후 전체가 유휴
