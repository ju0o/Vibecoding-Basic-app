...
| 50 | C | tokenization-and-context | ai-basics | 1 | deep-dive | 토큰화와 컨텍스트 비용 | 기초 | ai-vibe-coding-orientation | tokenization-context | generated |
| 51 | C | prompt-engineering-foundations | ai-basics | 2 | deep-dive | Prompt Engineering의 기본 원리 | 기초 | tokenization-and-context | prompt-engineering | generated |
| 52 | D | grounding-and-citations | ai-basics | 3 | reference | Grounding과 citation 레퍼런스 | 기초 | prompt-engineering-foundations | grounding-citations | generated |
| 53 | C | hallucination-and-verification | ai-basics | 4 | deep-dive | 환각과 검증 루틴 | 기초 | grounding-and-citations | hallucination-verification | generated |
