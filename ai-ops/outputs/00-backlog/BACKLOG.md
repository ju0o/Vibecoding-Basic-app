...
| 58 | B | chat-coding-era | ai-coding-tools | 2 | deep-dive | 챗 코딩 시대: 대화형 개발의 장점과 한계 | 기초 | autocomplete-era | chat-coding-era | v2-released |
...
| 63 | B | ai-code-review-tools | ai-coding-tools | 7 | deep-dive | AI 코드 리뷰 도구와 한계 | 중급 | frontend-testing-basics | ai-code-review-tools | v2-released |
...
| 83 | A | ai-assisted-testing-loop | practical-vibe-coding | 4 | deep-dive | AI와 테스트 루프 설계 | 중급 | frontend-testing-basics | ai-assisted-testing-loop | v2-released |
| 84 | B | refactoring-with-ai | practical-vibe-coding | 5 | deep-dive | AI와 리팩터링하기 | 중급 | code-change-risk-analysis | refactoring-with-ai | v2-released |
| 85 | B | reviewing-ai-output | practical-vibe-coding | 6 | deep-dive | AI 결과물 리뷰하는 법 | 기초 | hallucination-and-verification | reviewing-ai-output | v2-released |
| 86 | A | incident-style-ai-debugging | practical-vibe-coding | 7 | deep-dive | 장애 대응식 AI 디버깅 | 중급 | monitoring-errors-rollbacks | incident-ai-debugging | v2-released |
...
| 91 | D | explain-risk-and-verification | explanation-practice | 5 | reference | 위험과 검증 설명 레퍼런스 | 중급 | reviewing-ai-output | explain-risk-verification | integrated |
| 92 | A | mini-saas-architecture | project-textbook | 1 | deep-dive | 미니 SaaS 아키텍처 교재 | 중급 | auth-session-token | mini-saas-architecture | integrated |
| 93 | A | admin-dashboard-project | project-textbook | 2 | deep-dive | 관리자 대시보드 프로젝트 교재 | 중급 | react-state-and-effects | admin-dashboard-project | integrated |
| 94 | C | ai-chatbot-project | project-textbook | 3 | deep-dive | AI 챗봇 프로젝트 교재 | 중급 | rag-fundamentals | ai-chatbot-project | integrated |
| 95 | C | automation-workflow-project | project-textbook | 4 | deep-dive | 자동화 Workflow 프로젝트 교재 | 중급 | ai-workflow-design | automation-workflow-project | integrated |
