...
| 37 | A | rest-api-design | data-backend | 2 | deep-dive | REST API 설계와 상태 코드 | 기초 | api-db-backend-flow | rest-api-design | planned |
| 38 | A | database-tables-indexes | data-backend | 3 | deep-dive | DB 테이블, 인덱스, 쿼리 기초 | 기초 | api-db-backend-flow | database-tables-indexes | planned |
