...
| Current State | Phase 3 P-05 T08 Wave 1 완료: ai-basics 4개 Lesson integrated / verify 대기 |
| Last Completed Step | Codex P-05 Site Integration T08 Wave 1 (4 lessons integrated, lint/typecheck PASS, 2026-07-05) |
| Next Executor | Codex |
| Next Prompt File | `prompts/RUN-CODEX-PRODUCE.md` |
| Blocker | 없음 |
| Required Human Action | None — 같은 Codex 흐름에서 integrated lesson 4건 verify/release 진행 |
...
```
NEXT_ACTION:
- Current State: CODEX-PLAN Phase 3 P-05 T08 Wave 1 완료 — ai-basics Lesson 4건 integrated, verify 대기
- Verdict: APPROVED
- Next Executor: Codex
...
- If Approved: verify 통과 시 T08 Wave 1 released 처리 후 다음 planned/needed 항목으로 계속 진행
- If Rejected: 실패 로그를 build_fail로 기록하고 P-07 수정 루프로 진행
- Files to Check: src/content/curriculum.ts, src/content/glossary.ts, src/content/lessons/markdown/tokenization-and-context.md, src/content/lessons/markdown/prompt-engineering-foundations.md, src/content/lessons/markdown/grounding-and-citations.md, src/content/lessons/markdown/hallucination-and-verification.md
...
- 강의: **V2 released 17강** (V2 Wave 1+2+3+4 — 배포는 HOLD, 운영자 게이트) / T08 integrated 4강 verify 대기 / T08 planned 1강(embeddings-and-similarity)
