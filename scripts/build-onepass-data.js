...
const DECK_WEEKS = [
  {
    n: 2, moduleId: 'W2', moduleTitle: 'W2 · CLI · MCP · SKILL',
    title: 'CLI로 바이브코딩 + MCP·Skill 이해',
    subtitle: '터미널 작업 흐름과 외부 능력(MCP)·반복 자산(Skill)의 개념·사용',
    objective: '터미널에서 일하는 법, AI에 외부 능력을 끼우는 MCP, 반복을 자산으로 만드는 Skill을 한 흐름으로 이해합니다.',
    deck: 'sessions/onepass-week2.html', slideCount: 11,
    sources: ['claude-overview', 'claude-mcp', 'claude-skills', 'codex-overview'],
    deliverables: ['CLI로 작은 변경 1건', '필요한 MCP 1개 연결', '반복 작업 1개 Skill 후보 메모'],
  },
  {
    n: 3, moduleId: 'W3', moduleTitle: 'W3 · BUILD · PARALLEL',
    title: '나만의 MCP·Skill 만들기 + SubAgent·Workflow',
    subtitle: '직접 제작 — Skill·MCP 제작, 작업을 나누는 SubAgent, 반복 자동화 Workflow',
    objective: '반복 작업을 나만의 Skill·MCP로 만들고, SubAgent로 병렬 처리하며, Workflow로 자동화합니다.',
    deck: 'sessions/onepass-week3.html', slideCount: 10,
    sources: ['claude-skills', 'claude-mcp', 'claude-subagents', 'anthropic-eng-multiagent'],
    deliverables: ['나만의 Skill 1개', '연결한 MCP 1개', '작업 분해·병렬 계획', '자동화 Workflow 초안'],
  },
  {
    n: 4, moduleId: 'W4', moduleTitle: 'W4 · ORCHESTRATION · AI OFFICE',
    title: '오케스트레이션 + 나만의 AI 사무실',
    subtitle: '만든 조각을 하나의 흐름으로 — 결정적+에이전틱, 핸드오프·정지조건, 역할별 에이전트',
    objective: 'Skill·MCP·SubAgent·Workflow를 하나의 흐름으로 묶고, 역할을 나눈 나만의 AI 사무실을 운영합니다.',
    deck: 'sessions/onepass-week4.html', slideCount: 9,
    sources: ['anthropic-eng-agents', 'anthropic-eng-multiagent', 'github-actions', 'openai-agents-sdk'],
    deliverables: ['오케스트레이션 흐름도', '정지조건·복구 경로', '역할별 AI 사무실 구성', '4주 통합 적용 계획'],
  },
];
const deckSession = (w) => ({
...
const manifest = {
  ...
  visibility: 'preview',
  audience: ['studio'],
  curriculumVersion: 'ONEPASS-W1-PILOT',
  description: COURSE.description,
  color: COURSE.color,
  route: COURSE.route,
  outcomes: COURSE.outcomes,
