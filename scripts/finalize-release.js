...
## 강의와 자료
- 과정 선택 후 \`강의 / 자료실\` 탭을 사용합니다.
- \`자료실\`에서 강의 보충자료, 강사용 연구자료, 공식자료 요약을 함께 확인합니다.
- 공식 문서는 자료실의 공식자료 요약에서 배경, 쉬운 비유, 오해, 시연 포인트와 수업 전 체크를 확인합니다.
...
- 강의, 자료실 2탭 운영 UI
- Ctrl+K 과정·회차·보충자료·강사용 연구자료·공식자료 검색
