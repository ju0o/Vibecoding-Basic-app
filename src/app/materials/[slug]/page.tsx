        ...
        <article className="min-w-0">
          <div className="mx-auto max-w-[72ch] rounded-xl border border-[var(--border-default)] bg-[var(--surface-elevated)] p-5 sm:p-8">
            <div className="flex flex-wrap gap-2">
              <Link
                className="rounded-lg border border-[var(--border-subtle)] px-2.5 py-1 text-xs font-semibold text-[var(--text-secondary)] transition hover:border-[var(--accent-primary)] hover:text-[var(--accent-primary)]"
                href="/materials"
              >
                ← 자료실로 돌아가기
              </Link>
            ...
            <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
              <div>
                ...
                <p className="mt-2 text-sm leading-6 text-[var(--text-secondary)]">
                  이 자료를 다시 읽었다면 완료로 표시하세요. 진행률은 이 브라우저에만 저장됩니다.
                </p>
              </div>
