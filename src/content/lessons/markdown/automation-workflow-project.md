...
![자동화 Workflow 프로젝트: trigger, jobs, dependency, tool boundary, result record가 이어지는 실행 구조](/lesson-diagrams/automation-workflow-project/workflow-dependency-graph.svg)
